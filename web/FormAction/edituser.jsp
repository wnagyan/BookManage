...
<div id = "background">
    ...
    <%
        ...
        session.setAttribute("studentid", idstudent);
        String username = rs.getString("username");
        String classe = rs.getString("classe");
    %>
    <div id="zhuti">
        <div id="neirong">
            <form action="checkEditUser.jsp" method="post">
                <fieldset>
                    <div id="studentid" class="abc">
                        <label for="studentid">学号</label>
                        <input type="text" name="studentid" size="15" value="<%=studentid%>" required class="xyz">
                    </div>
                    <div id = "username" class="abc">
                        <label for = "username">姓名</label>
                        <input type="text" name="username" size="15" value="<%=username%>" required class="xyz">
                    </div>
                    <div id="classe" class="abc">
                        <label for="classe">班级</label>
                        <input type="text" name="classe" size="15" value="<%=classe%>" required class="xyz">
                    </div>
                    <div id="submit">
