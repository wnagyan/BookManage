...
<div id="background">
    ...
    <div id="zhuti">
        <div id="neirong">
            <form action="checkEditBooks.jsp" method="post">
                <fieldset>
                    <div id="bookname" class="abc">
                        <label for="bookname">书名</label>
                        <input type="text" name="bookname" size="15" value="<%=bookname%>" required class="xyz">
                    </div>
                    <div id = "bookid" class="abc">
                        <label for = "bookid">书号</label>
                        <input type="text" name="bookid" size="15" value="<%=booksid%>" required class="xyz">
                    </div>
                    <div id="bookauthor" class="abc">
                        <label for="bookauthor">作者</label>
                        <input type="text" name="bookauthor" size="15" value="<%=bookauthor%>" class="xyz">
                    </div>
                    <div id="bookprice" class="abc">
                        <label for="bookprice">价格</label>
                        <input type="text" name="bookprice" size="15" value="<%=bookprice%>" class="xyz">
                    </div>
                    <div id="bookcount" class="abc">
                        <label for="bookcount">数量</label>
                        <input type="text" name="bookcount" size="15" value="<%=bookcount%>" required class="xyz">
                    </div>
                    <div id="bookpress" class="abc">
                        <label for="bookpress">出版社</label>
                        <input type="text" name="bookpress" size="15" value="<%=bookpress%>" class="xyz">
                    </div>
                    <div id="bookdata" class="abc">
                        <label for="bookdata">出版日期</label>
                        <input type="text" name="bookdata" size="15" value="<%=bookdata%>" class="xyz">
                    </div>
                    <div id="submit">
                        <input type="submit" value="修改" class="submit">
                        <a href="editbooks.jsp"><input type="reset" value="重填" class="reset"></a>
                    </div>
                </fieldset>
            </form>
        </div>
